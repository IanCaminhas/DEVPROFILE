...
export const HeaderTitle = styled.Text`
  ...
  font-weight: bold;
`;
//esse auto é para ficar centralizado
...
`;
/*
Esse é btn para o user tocar e alterar a foto de avatar dele
 bottom: ${RFValue(-16)}px;
right: ${RFValue(-16)}px;

  Se eu colocar 0 para bottom/right, vai ficar no canto da imagem
*/
export const PhotoButton = styled.View`
  ...
  right: ${RFValue(-16)}px;
`;
//  justify-content: space-around; tinha isso daqui. Foi substituído por margin-top
...
//${RFValue(16)}px acima e abaixo. ${RFValue(24)}px esquerda/direita
//margin-bottom: 16px; -> para separar do conteúdo de cima
